...
function validate()
{
               if( document.myForm.namaadmin.value == "" )
   {
     alert( "Nama Admin Harus Diisi" );
     document.myForm.namaadmin.focus() ;
     return false;
   }
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
     ...
     <?
require ("connect.php");
$query="select MAX(kdadmin) from admin";
$result = mysql_query($query) or die(mysql_error());
$row =  mysql_fetch_array($result);
$kdadmin1 = $row['MAX(kdadmin)'];
if($kdadmin1 == null){
$kdadmin1 = 1;
}
else{
...
?>
  <form action="prosesadminaddadmin.php" name="myForm" onSubmit="return(validate());" method="post">
<table width="500" border="0" cellpadding="4" cellspacing="10">
  <tr>
    <td width="150">Nama Admin</td>
    <td width="144"><label>
      <input type="text" name="namaadmin" id="namaadmin" class="text" size="45"  />
    </label></td>
  </tr>
    <tr>
    <td width="150">Email</td>
    <td width="144"><label>
      <input type="text" name="email" id="email" class="text" size="45"  />
    </label></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><label>
       <input type="hidden" name="kdadmin" id="kdadmin" value="<? echo $kdadmin1 ?>" />
