...
<div class="main">
  ...
  <div class="content">
   ...
   <?
require ("connect.php");
$query="select MAX(kdjadwal) from jadwal";
$result = mysql_query($query) or die(mysql_error());
$row =  mysql_fetch_array($result);
$kdjadwal = $row['MAX(kdjadwal)'];
if($kdjadwal == null){
$kdjadwal = "J-001";
}
else{
...
?>
  <form action="prosesadminaddjadwal.php" name="myForm" onSubmit="return(validate());" method="post">
<table width="500" border="0" cellpadding="4" cellspacing="10">
  ...
  <tr>
    ...
    <td width="144"><label>
         <select name="kdpenyewa" id="kdpenyewa" class="button5">
          <?
		  require("connect.php");
		  $query1 = "select * from penyewa where status = 'Member' order by kdpenyewa asc";
		  $result1 = mysql_query($query1);
  ...
  <tr>
    ...
    <td width="144"><label>
    <select name="hari" id="hari" class="button7">
