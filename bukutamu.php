  ...
  <div class="content">
    <div class="content_resize">
     ...
     <br/>
      ...
      <?
require ("connect.php");
$query="select MAX(kdbukutamu) from bukutamu";
$result = mysql_query($query) or die(mysql_error());
$row =  mysql_fetch_array($result);
$kdbukutamu = $row['MAX(kdbukutamu)'];
if($kdbukutamu == null){
$kdbukutamu = 1;
}
else{
...
?>
  <form action="prosesbukutamu.php" name="myForm" onSubmit="return(validate());" method="post">
<table width="500" border="0" cellpadding="4" cellspacing="10">
  <tr>
    ...
    <td width="150">Isi</td>
    <td width="144"><label>
  <textarea name="isi" cols="" rows="5"></textarea>
    </label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><label>
       <input type="hidden" name="kdbukutamu" id="kdbukutamu" value="<? echo $kdbukutamu ?>" />
