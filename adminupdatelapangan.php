...
function validate()
{
               if( document.myForm.nolapangan.value == "" )
   {
     alert( "No Lapangan Harus Diisi" );
     document.myForm.nolapangan.focus() ;
     return false;
   }
...
<div class="main">
  ...
  <?php
		...
		$gambar=$row['gambar'];
		?>
  <form action="prosesadminupdatelapangan.php" method="post" enctype="multipart/form-data" name="myForm" onSubmit="return(validate());">
<table width="500" border="0" cellpadding="4" cellspacing="10">
  <tr>
    <td width="150">Gambar</td>
    <td width="144">
      <label>
   <img src="<? echo $gambar; ?>" width="600px" height="400px" />     
    </label></td>
  </tr>
  <tr>
    <td width="150">No Lapangan</td>
    <td width="144"><label>
      <input type="text" name="nolapangan" id="nolapangan" class="text" size="45" value="<? echo $nolapangan; ?>"  />
    </label></td>
  </tr>
    <tr>
    <td width="150">Keterangan</td>
    <td width="144"><label>
     <textarea name="keterangan" cols="15" rows="6"><? echo $keterangan; ?></textarea>
    </label></td>
  </tr>
