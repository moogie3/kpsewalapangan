...
$kdpenyewa = $_GET['kdpenyewa'];
 	$query3="select * from penyewa where kdpenyewa = '$kdpenyewa'";
		$result3 = mysql_query($query3) or die(mysql_error());
		$row3 =  mysql_fetch_array($result3);
		$namapenyewa = $row3['nama'];
		$telp=$row3['telp'];
		$alamat=$row3['alamat'];
...
$kdsewa++;
		...
		$gambar=$row['gambar'];
		?>
  <form action="prosespesanlapanganmember.php" method="post" enctype="multipart/form-data" name="myForm" onSubmit="return(validate());">
