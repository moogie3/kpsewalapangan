...
function validate()
{
               if( document.myForm.kdsewa.value == "" )
   {
     alert( "Kode Sewa Harus Diisi" );
     document.myForm.kdsewa.focus() ;
     return false;
   }
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
     ...
     <br/>
      <div align="justify"> 
    <form action="carikonfirmsi.php" name="myForm" onSubmit="return(validate());" method="post">
<table width="500" border="0" cellpadding="4" cellspacing="10">
  <tr>
    <td width="150">Kode Sewa</td>
    <td width="144"><label>
      <input type="text" name="kdsewa" id="kdsewa" class="text" size="45"  />
    </label></td>
  </tr>
