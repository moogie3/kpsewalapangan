...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
     ...
     <?php
		require ("connect.php");
		$kdadmin1 = $_GET['kdadmin'];
		$query="select * from admin where kdadmin = '$kdadmin1'";
		...
		$email=$row['email'];
		?>
  <form action="prosesadminupdateadmin.php" name="myForm" onSubmit="return(validate());" method="post">
<table width="500" border="0" cellpadding="4" cellspacing="10">
  <tr>
    ...
    <td width="144"><label>
      <input type="text" name="email" id="email" class="text" size="45" value="<? echo $email; ?>"  />
    </label></td>
  </tr>
  <tr>
