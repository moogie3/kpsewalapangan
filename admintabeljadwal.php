...
<div class="main">
  ...
  Kode Jadwal : <input name="key" type="text" size="20" class="text" /> <input type="submit"  value="Cari" class="button"  />
  </form>
<br/>
  <table>
  <thead>
 ...
 <?php
    ...
    <td > <div align="center"><a href="adminaddbayar.php?kdjadwal=<?php echo $row['kdjadwal']?>">Input</a>&nbsp;&nbsp;&nbsp;
    <a href="admintabelbayar.php?kdjadwal=<?php echo $row['kdjadwal']?>">Lihat</a>
    </div></td>
    
    <td > <div align="center"><a href="admindeletejadwal.php?kdjadwal=<?php echo $row['kdjadwal']?>" onClick="return confirm('Anda Yakin Mau Menghapus Data Ini?');">Hapus</a></div></td>
  </tr>
  </tbody>
                   <?php
				   $i++;
 ...
 Halaman :		 <?php
	...
	for($i=$hmulai;$i<=$hakhir;$i++)
	{
		...
		{
			echo "<a href='admintabeljadwal.php?hal=".$i."'> [ ".$i." ] </a> "; 
		}
	}
	// cetak ">"
	if($hal!=$jlhhal)
