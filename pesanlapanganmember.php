...
function validate()
{
               if( document.myForm.kdpenyewa.value == "" )
   {
     alert( "Kode Member Harus Diisi" );
     document.myForm.kdpenyewa.focus() ;
     return false;
   }
...
?>
  <form action="cekpesanlapanganmember.php" name="myForm" onSubmit="return(validate());" method="post">
<table width="500" border="0" cellpadding="4" cellspacing="10">
   <tr>
    <td width="150">Kode Member</td>
    <td width="144"><label>
      <input type="text" name="kdpenyewa" id="kdpenyewa" class="text" size="45"  />
    </label></td>
  </tr>
  <tr>
