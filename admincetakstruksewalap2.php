...
<hr/>
 <?php
		require ("connect.php");
		$kdsewa = $_GET['kdsewa'];
		$query8="select * from sewa a,bayar b where a.kdsewa = b.kdsewa and a.kdsewa = '$kdsewa'";
		$result8 = mysql_query($query8) or die(mysql_error());
		$row8 =  mysql_fetch_array($result8);
		$kdsewa = $row8['kdsewa'];
		$kdbayar = $row8['kdbayar'];
		...
		$kdlapangan = $row8['kdlapangan'];
		$kdpenyewa=$row8['kdpenyewa'];
		$harisewa=$row8['harisewa'];
		$jamsewa=$row8['jamsewa'];
		$lamasewa=$row8['lamasewa'];
		$tglsewa=$row8['tglsewa'];
		$statussewa=$row8['status'];
		$tarifsewa=$row8['tarifsewa'];
...
<table width="800" border="1" cellpadding="4" cellspacing="0">
  <tr>
    <td width="229" bgcolor="#FFFF99">Kode Sewa</td>
    <td width="549" bgcolor="#FFFF99"><label>
      : <? echo $kdsewa; ?>
    </label></td>
  </tr>
  <tr>
    <td width="229" bgcolor="#FFFF99">No. Lapangan</td>
    <td width="549" bgcolor="#FFFF99"><label>
        : <? echo $nolapangan; ?> (<?php echo 'Rp. '.number_format($tarifsewa,2,",","."); ?> / Jam)
    </label></td>
  </tr>
    <tr>
    <td width="229" bgcolor="#FFFF99">Penyewa</td>
    <td width="549" bgcolor="#FFFF99"><label>
      : <? echo $nama; ?> (<? echo $status; ?>) - <? echo $telp; ?>
    </label></td>
  </tr>
  <tr>
    <td width="229" bgcolor="#FFFF99">Hari</td>
    <td width="549" bgcolor="#FFFF99"><label>
   : <? echo $harisewa; ?>
    </label></td>
  </tr>
    ...
    <tr>
    <td width="229" bgcolor="#FFFF99">Jam</td>
    <td width="549" bgcolor="#FFFF99"><label>
      : <? echo $jamsewa; ?> : 00 - <? echo $jamakhir; ?> : 00 
    </label></td>
  </tr>
    <tr>
    <td width="229" bgcolor="#FFFF99">Tanggal Sewa</td>
    <td width="549" bgcolor="#FFFF99"><label>
   : <? echo $tglsewa; ?>
    </label></td>
  </tr>
  <tr>
    <td width="229" bgcolor="#FFFF99">Status</td>
    <td width="549" bgcolor="#FFFF99"><label>
   : <? echo $statussewa; ?>
    </label></td>
  </tr>
 <tr>
    <td width="229" bgcolor="#FFFF99">Kode Bayar</td>
    <td width="549" bgcolor="#FFFF99"><label>
   : <? echo $kdbayar; ?>
    </label></td>
  </tr>
   <tr>
    <td width="229" bgcolor="#FFFF99">Total Sewa </td>
    <td width="549" bgcolor="#FFFF99"><label>
   : <?php 
   ...
   echo 'Rp. '.number_format($totalsewa,2,",","."); ?>
      ...
      <tr>
    <td width="229" bgcolor="#FFFF99">Tanggal Bayar</td>
    <td width="549" bgcolor="#FFFF99"><label>
     : <? echo $tglbayar ?>
    </label></td>
  </tr>
  <tr>
    <td width="229" bgcolor="#FFFF99">Tanggal Lunas</td>
    <td width="549" bgcolor="#FFFF99"><label>
     : <? echo $tgllunas ?>
    </label></td>
  </tr>
  <tr>
    <td width="229" bgcolor="#FFFF99">Keterangan</td>
    <td width="549" bgcolor="#FFFF99"><label>
     : <? echo $keterangan ?>
    </label></td>
  </tr>
      <tr>
    <td width="229" bgcolor="#FFFF99">Diskon</td>
    <td width="549" bgcolor="#FFFF99"><label>
     : <?php 
   ...
   <tr>
    <td width="229" bgcolor="#FFFF99">DP (Uang Muka)</td>
    <td width="549" bgcolor="#FFFF99"><label>
    : <?php 
   ...
   <tr>
    <td width="229" bgcolor="#FFFF99">Sisa Yang Harus Dibayar</td>
    <td width="549" bgcolor="#FFFF99"><label>
   : <?php 
