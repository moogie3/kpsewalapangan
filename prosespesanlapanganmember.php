...
document.location='pesanlapanganakhirmember.php?kdlapangan=<? echo $kdlapangan; ?>&kdpenyewa=<? echo $kdsewa; ?>'</script>
<?
}
else if($ceksewa == 1){
  ?>
...
document.location='cetakstrukpesanmember.php?kdsewa=<? echo $kdsewa; ?>'</script>
<?   
} 
?>